...
import imagescover from '../../asset/img/CoverImages/Tcover.webp'; // Ensure the path is correct
...
const images = importAll(require.context('../../asset/img/Tranining', false, /\.(webp|jpg|jpeg|png)$/));
        ...
        <section className='galary-events'>
            <div className="covers">
                ...
                <div className='slogan'>
                    <Heading title="Training" subtitle="Temerachi Coffee Export" />
                </div>
            </div>
