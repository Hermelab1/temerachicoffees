...
import imagescover from '../../asset/img/CoverImages/Tcover.jpg'; // Ensure the path is correct
...
const images = importAll(require.context('../../asset/img/Tranining', false, /\.(jpg|jpeg|png)$/));
