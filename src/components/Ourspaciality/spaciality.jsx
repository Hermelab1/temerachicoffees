    ...
    <section className="bg-gray-100 overflow-hidden flex flex-col items-center justify-center mx-auto z-10">
      ...
      <div className='container mx-auto'>
        {uniqueTech.map((item, index) => {
          ...
          const itemClass = `relative 2xl:w-[39%] xl:w-[45%] lg:w-[43%] md:w-[43%] w-[80%] opacity-0 flex flex-col items-start mb-2 ${isEvenIndex ? 'animate-move-left ml-[4.5rem] 2xl:ml-[7%] xl:ml-[2%] lg:ml-[3%] md:ml-[10%]' : 'animate-move-right ml-[4.5rem] 2xl:ml-[53%] xl:ml-[52%] lg:ml-[53%] md:ml-[52%]'}`;
