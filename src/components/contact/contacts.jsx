    ...
    <section className='contact'>
      <div className='container mx-auto text-center flex flex-wrap justify-center items-center lg:gap-12 md:gap-20 sm:gap-12 my-4'>
        ...
        <div className="pages text-center">
          ...
          <div className="flex flex-row sm:flex-col justify-center mt-4 leading-9"> 
          <Link onClick={() => handleScrollToTopAndNavigate('/')} className="mx-2 text-[105F4E]-600 font-medium text-xl text-left">Home</Link>
