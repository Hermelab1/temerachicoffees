          ...
          >
            {testimonial.map((item, index) => (
              <SwiperSlide key={`testimonial-${index}`}>
                <div className="border-2 border-gray-200 shadow-custom p-6 md:p-4 flex flex-col lg:p-2  2xl:h-[60vh] xl:h-[65vh] lg:h-[80vh] md:h-[55vh] sm:h-[50vh] shadow-lg text-center justify-center item-center mb-12">
